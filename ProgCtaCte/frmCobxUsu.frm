...
Begin VB.Form frmCobxUsu 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Reporte de Cobranzas Por Rango de Fechas y Usuario"
   ClientHeight    =   8055
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   13845
   ...
   Begin VB.ComboBox cmbCia 
      Height          =   315
      ItemData        =   "frmCobxUsu.frx":0000
      Left            =   1080
      List            =   "frmCobxUsu.frx":0002
...
Private Sub Form_Activate()
   ...
   txtUsu.Text = wcodusu
   lblUsu.Caption = wnomusu
   
   txtDesde.SetFocus
End Sub

Private Sub Form_Load()
   frmCobxUsu.Left = (Screen.Width - Width) \ 2
   frmCobxUsu.Top = 0
End Sub
...
Private Sub LlenaCab()
   ...
   & "       (C.FECHA <= '" + Format(whas, "dd/mm/yyyy") + "') AND " _
   & "       (C.USU = '" + wcodusu + "')  ")
   Db.CommitTrans
   ...
   & " SET BLOQUE = '2' " _
   & " WHERE USU = '" + wcodusu + "' AND " _
   & "       SERCOB = '004' AND MONDOC = 'S' AND FORPAG <> '08' ")
   Db.CommitTrans
   ...
   & " SET BLOQUE = '3' " _
   & " WHERE USU = '" + wcodusu + "' AND " _
   & "       SERCOB = '004' AND MONDOC = 'D' AND FORPAG <> '08' ")
   Db.CommitTrans
