...
Begin VB.Form frmConSdosxSocio 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Consulta de Saldos Por Socio"
   ClientHeight    =   8475
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   13920
   ...
   Begin VB.ComboBox cmbE_Socio 
      Height          =   315
      ItemData        =   "frmConSdosxSocio.frx":0000
      Left            =   1320
      List            =   "frmConSdosxSocio.frx":0002
   ...
   Begin VB.ComboBox cmbConcepto 
      Height          =   315
      ItemData        =   "frmConSdosxSocio.frx":0004
      Left            =   1320
      List            =   "frmConSdosxSocio.frx":0006
      Style           =   2  'Dropdown List
      TabIndex        =   2
      Top             =   480
      Width           =   3375
   ...
   Begin VB.ComboBox cmbCia 
      Height          =   315
      ItemData        =   "frmConSdosxSocio.frx":0008
      Left            =   1320
      List            =   "frmConSdosxSocio.frx":000A
      Style           =   2  'Dropdown List
      TabIndex        =   0
      Top             =   165
      Width           =   7335
   ...
   End
End
Attribute VB_Name = "frmConSdosxSocio"
...
Private Sub cmdExportar_Click()
   ...
   aa = Leerado3("SELECT * FROM TMP_CTASXCAB WHERE USU = '" + wcodusu + "' ORDER BY NOMBRE, MES, CONCEPTO ")
   If aa > 0 Then
      V = 4
      H = 1
      wRegAct = 1
      ...
      Do While Not ADO3.EOF
         ...
         objExcel.Cells(V, H + 5) = "TOTALES X SOCIO"
...
Private Sub cmdImprimir_Click()
   ...
   Crys1.ReportFileName = xraiz + "ReportCtaCte\SdosxSoc.RPT"
...
Private Sub Form_Load()
   frmConSdosxSocio.Left = (Screen.Width - Width) \ 2
   frmConSdosxSocio.Top = 0
End Sub
