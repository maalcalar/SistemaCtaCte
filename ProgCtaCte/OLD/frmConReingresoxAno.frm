...
Begin VB.Form frmConReingresoxAno 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Relacion de ReIngresos x Año"
   ClientHeight    =   8010
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   10530
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "RELACION DE ASOCIADOS REINGRESANTES POR AÑO"
      ColumnCount     =   2
   ...
   End
End
Attribute VB_Name = "frmConrEIngresoxAno"
...
Private Sub cmdExportar_Click()
   ...
   Heading(4) = "ESTADO"
   Heading(5) = "FEC.REING"
   aa = Leerado3("SELECT * FROM TMP_SOCIOS WHERE USU = '" + wcodusu + "' ORDER BY FECREIN, NOMBRE ")
   If aa > 0 Then
      wTot = aa
      ...
      With objExcel
           ...
           .Cells(1, 1) = wnomcia
           .Cells(2, 1) = "RELACION DE ASOCIADOS REINGRESANTES - EJERCICIO " + txtAno.Text
           For I = 1 To 6 Step 1
      ...
      Do While Not ADO3.EOF
         ...
         If IsDate(ADO3!fecrein) Then
            wFec = Format(ADO3!fecrein, "dd/mm/yyyy")
...
Private Sub cmdImprimir_Click()
   ...
   Crys1.ReportFileName = xraiz + "ReportCtaCte\RepReingxAno.RPT"
...
Private Sub Form_Initialize()
   frmConrEIngresoxAno.Left = (Screen.Width - Width) \ 2
   frmConrEIngresoxAno.Top = 0
End Sub
...
Private Sub LlenaCab()
   ...
   & " (CODSOCIO, CODIGO, INS, NOMBRE, E_SOCIO, FECREIN, MONEDA, APORTE, " _
   & "  USU ) " _
   & " SELECT " _
   & "  S.CODSOCIO, S.CODIGO, S.INS, S.NOMBRE, S.E_SOCIO, S.FECREIN, " _
   & "  E.MONEDA, E.APORTE, '" + wcodusu + "' " _
   & " FROM MAESOCIO AS S INNER JOIN MAEE_SOCIO AS E " _
   & "   ON S.E_SOCIO = E.E_SOCIO " _
   & " WHERE YEAR(S.FECREIN) =  " + Str(Val(wAno)) + "  ")
   Db.CommitTrans

   aa = Leerado2("SELECT CODSOCIO, CODIGO, INS, NOMBRE, E_SOCIO, FECREIN, " _
                & "      MONEDA, APORTE " _
                & " FROM TMP_SOCIOS " _
                & " WHERE usu = '" + wcodusu + "' " _
   ...
   DataGrid1.Columns(5).Caption = "FEC.REING"
