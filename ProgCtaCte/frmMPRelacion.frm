...
Begin VB.Form frmMPRelacion 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Relación Socios Cobro x CAJA MILITAR POLICIAL"
   ClientHeight    =   7755
   ClientLeft      =   45
   ClientTop       =   390
   ClientWidth     =   10500
   ...
   Begin VB.ComboBox cmbCia 
      Height          =   315
      ItemData        =   "frmMPRelacion.frx":0000
      Left            =   1080
      List            =   "frmMPRelacion.frx":0002
   ...
   End
End
Attribute VB_Name = "frmMPRelacion"
...
Private Sub cmdExportar_Click()
   ...
   With objExcel
        ...
        .Cells(1, 1) = wnomcia
        .Cells(2, 1) = "RELACION DE SOCIOS CON DESCUENTO CAJA MILITAR POLICIAL"
        For I = 1 To 6 Step 1
...
Private Sub cmdImprimir_Click()
   ...
   Crys1.ReportFileName = xraiz + "ReportCtaCte\CAJMPRelacion.RPT"
...
Private Sub Form_Activate()
   frmMPRelacion.Left = (Screen.Width - Width) \ 2
   frmMPRelacion.Top = 0
