...
Begin VB.Form frmSelecSocio2 
   ...
   End
End
Attribute VB_Name = "frmSelecSocio2"
...
Private Sub Form_Activate()
   frmSelecSocio2.Left = (Screen.Width - Width) \ 2
   frmSelecSocio2.Top = 0
...
Private Sub LlenaCab()
   ...
   lblMensaje.Caption = "Buscando Socios.... Espere"
   lblMensaje.Refresh
   ...
   Else
      wsql = "SELECT CODSOCIO, CODIGO, INS, NOMBRE, E_SOCIO " _
              & " FROM MAESOCIO " _
              & " WHERE UPPER(NOMBRE) LIKE UPPER('%" + Trim(xseleccion) + "%') " _
              & " ORDER BY NOMBRE"
   End If
   lblMensaje.Caption = ""
   lblMensaje.Refresh
