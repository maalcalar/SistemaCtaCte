...
Begin VB.Form frmConRenovaAnual 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Resumen Renovaciones Anuales"
   ClientHeight    =   8175
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   14370
   ...
   Begin VB.ComboBox cmbE_Socio 
      Height          =   315
      ItemData        =   "frmConRenovaAnual.frx":0000
      Left            =   1440
      List            =   "frmConRenovaAnual.frx":0002
   ...
   End
End
Attribute VB_Name = "frmConRenovaAnual"
...
Private Sub cmdExportar_Click()
   ...
   With objExcel
        ...
        .Cells(1, 1) = wnomcia
        .Cells(2, 1) = "RESUMEN DE RENOVACIONES CIVILES - EJERCICIO " + wAno
...
Private Sub cmdImprimir_Click()
   ...
   Crys1.ReportFileName = xraiz + "ReportCtaCte\RenovaxAno.RPT"
...
Private Sub Form_Activate()
   ...
   a = Leerado8("SELECT * FROM MAEE_SOCIO WHERE E_SOCIO = 'TRA' ORDER BY E_SOCIO ")
   If a > 0 Then
      ADO8.MoveFirst
      I = 0
   ...
   cmbE_Socio.Enabled = False
   
   txtAno.SetFocus
End Sub

Private Sub Form_Load()
   frmConRenovaAnual.Left = (Screen.Width - Width) \ 2
   frmConRenovaAnual.Top = 0
End Sub
...
Private Sub LlenaCab()
   ...
   & " SELECT " _
   & "  M.CODSOCIO, M.CODIGO, M.INS, M.NOMBRE, M.E_SOCIO, M.FECING, E.MONREN, E.RENOVA, ROUND(E.RENOVA * 1,2),  '" + wcodusu + "' " _
   ...
   For II = 1 To 12
       ...
       & " FROM TMP_ANUAL_APORTE AS T INNER JOIN V_COBRO_RENOV AS V " _
