...
Begin VB.Form frmDIECOConSinDscto 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Consulta Socios DIECO Sin Descuento"
   ClientHeight    =   8805
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   13350
   ...
   Begin VB.ComboBox cmbMeses 
      Height          =   315
      ItemData        =   "frmDIECOConSinDscto.frx":0000
      Left            =   720
      List            =   "frmDIECOConSinDscto.frx":0002
   ...
   Begin VB.Label Label5 
      Alignment       =   2  'Center
      BorderStyle     =   1  'Fixed Single
      Caption         =   "Consulta Socios DIECO Sin Descuentos"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   13.5
         Charset         =   0
   ...
   End
End
Attribute VB_Name = "frmDIECOConSinDscto"
...
Private Sub cmdBuscar_Click()
   ...
   zz = Leerado2("SELECT CODSOCIO, NOMBRE, " _
                ...
                & "      CODENVIO, LIN     , " _
                & "      CODIGO  , INS     , FECENV  , " _
                & "      FECDSC  , TOTENVIO, DSCDIECO , DSCDIFER, USU " _
                & " FROM TMP_DIECOSOC " _
                & " WHERE USU = '" + wcodusu + "' " _
                & " ORDER BY MES, NOMBRE ")
...
Private Sub cmdExportar_Click()
   ...
   Dim aa As Integer, I As Integer, Heading(18) As String, _
   ...
   Heading(14) = "TELEFONOS"
   Heading(15) = "DIRECCION"
   Heading(16) = "UBIGEO"
   ...
   With objExcel
        ...
        objExcel.Columns("O").ColumnWidth = 25
        objExcel.Columns("P").ColumnWidth = 40
        objExcel.Columns("Q").ColumnWidth = 18
        objExcel.Columns("R").ColumnWidth = 30
        objExcel.Columns("S").ColumnWidth = 30
   End With
   ...
   If aa > 0 Then
      ...
      Do While Not ADO3.EOF
         ...
         objExcel.Cells(V, H + 6) = wUlt
         objExcel.Cells(V, H + 7) = wDon
         ...
         objExcel.Cells(V, H + 14) = wTel
         objExcel.Cells(V, H + 15) = wDir
         objExcel.Cells(V, H + 16) = wUbi
         objExcel.Cells(V, H + 17) = wRef
         objExcel.Cells(V, H + 18) = wMai
      ...
      objExcel.Range(objExcel.Cells(V, H + 11), objExcel.Cells(V, H + 13)).NumberFormat = "#####,##0.00"
      objExcel.Range(objExcel.Cells(V, H + 5), objExcel.Cells(V, H + 13)).Font.Color = RGB(255, 0, 0)
      objExcel.Range(objExcel.Cells(V, H + 5), objExcel.Cells(V, H + 13)).Font.Bold = True
      objExcel.Range(objExcel.Cells(V, H + 5), objExcel.Cells(V, H + 13)).Borders.Color = RGB(255, 0, 0)
...
Private Sub cmdImprimir_Click()
   ...
   Crys1.ReportFileName = xraiz + "ReportCtaCte\DIECOxSinDscto.RPT"
...
Private Sub cmdImpTes_Click()
   ...
   Crys1.Connect = "dsn=" + xodbc + "; uid=" + xUser + "; pwd=" + xPwd + ";dsq=" + xodbc + ""
   Crys1.ReportFileName = xraiz + "ReportCtaCte\DIECOxSinDsctoTeso.RPT"
   Crys1.Formulas(0) = "NOMBRECIA= '" + wnomcia + "' "
   Crys1.Formulas(1) = "RUCCIA= 'RUC " + wruccia + "' "
   Crys1.Formulas(2) = "NOMMES= 'MES " + Trim(funnommes(wMes)) + " DEL " + wAno + "' "
   Crys1.SelectionFormula = " {TMP_DIECOSOC.USU}='" + wcodusu + "' "
...
Private Sub CalxPag()
   ...
   Db.BeginTrans
   Db.Execute ("DELETE FROM TMP_DIECOSOC WHERE USU = '" + wcodusu + "' AND LIN > '5' ")
   Db.CommitTrans
   ...
   aa = Leerado8("SELECT * FROM TMP_DIECOSOC WHERE USU = '" + wcodusu + "' AND LIN <= '5' ")
   If aa > 0 Then
      wRegAct = 1
      wRegTot = aa
      ADO8.MoveFirst
      Do While Not ADO8.EOF
         ...
         If aa > 0 Then
            ...
            Else
               ...
               & " (USU, MES, CODENVIO, LIN, CODSOCIO, CODIGO, INS, " _
               & "  NOMBRE, TOTAPORT, TOTDEUDA, TOTADELA, " _
               ...
               & "  " + Str(ADO8!codigo) + ", " + Str(ADO8!ins) + ", " _
               & "  '" + ADO8!nombre + "', " _
...
Private Sub Command1_Click()
   ...
   With objExcel
        ...
        objExcel.Columns("V").ColumnWidth = 40
   End With
   ...
   If aa > 0 Then
      ...
      objExcel.Range(objExcel.Cells(V, H + 9), objExcel.Cells(V, H + 15)).NumberFormat = "#####,##0.00"
      ...
      objExcel.Cells(V, H + 9) = "TOTALES FINALES"
...
Private Sub Form_Initialize()
   frmDIECOConSinDscto.Left = (Screen.Width - Width) \ 2
   frmDIECOConSinDscto.Top = 0
...
Private Sub CalxSoc()
   ...
   & "  M.NOMBRE, C.FECENV, C.FECDSC, C.TOTAPORT, C.TOTDEUDA, " _
   ...
   & "  M.NOMBRE, C.FECENV, C.FECDSC, C.TOTASIG2, C.DEUASIG2, " _
   ...
   & "  M.NOMBRE, C.FECENV, C.FECDSC, C.TOTASIG3, C.DEUASIG3, " _
   ...
   & "  M.NOMBRE, C.FECENV, C.FECDSC, C.TOTASIG4, C.DEUASIG4, " _
   ...
   & "  M.NOMBRE, C.FECENV, C.FECDSC, C.TOTASIG5, C.DEUASIG5, " _
