...
Begin VB.Form frmCobBancoxRec 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Reporte de Cobranzas Aportaciones Por Bancos"
   ClientHeight    =   8055
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   13845
   ...
   Begin MSDataGridLib.DataGrid DataGrid1 
      ...
      BeginProperty Font {0BE35203-8F91-11CE-9DE3-00AA004BB851} 
         ...
         Strikethrough   =   0   'False
      EndProperty
      Caption         =   "RELACION DE COBROS DE APORTACIONES POR BANCOS"
      ColumnCount     =   2
   ...
   End
End
Attribute VB_Name = "frmCobBancoxRec"
...
Private Sub cmdImprimir_Click()
   ...
   Crys1.ReportFileName = xraiz + "ReportCtaCte\CobBancoxRec.RPT"
...
Private Sub Form_Load()
   frmCobBancoxRec.Left = (Screen.Width - Width) \ 2
   frmCobBancoxRec.Top = 0
End Sub
