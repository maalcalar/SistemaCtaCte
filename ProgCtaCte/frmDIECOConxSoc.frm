...
Begin VB.Form frmDIECOConxSoc 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Consulta DIECO Por Socio"
   ClientHeight    =   7440
   ClientLeft      =   45
   ClientTop       =   375
   ClientWidth     =   13350
   ...
   End
End
Attribute VB_Name = "frmDIECOConxSoc"
...
Private Sub cmdExportar_Click()
   ...
   Heading(8) = "ADELANTO"
   Heading(9) = "TOT.ENVIO"
   Heading(10) = "TOT.DSCTO"
   Heading(11) = "NO COBRADO"
   ...
   With objExcel
        ...
        .Cells(1, 1) = wnomcia
        .Cells(2, 1) = "DESCUENTO DIECO POR SOCIO"
   ...
   If aa > 0 Then
      ...
      Do While Not ADO3.EOF
         ...
         objExcel.Range(objExcel.Cells(V, H + 6), objExcel.Cells(V, H + 11)).NumberFormat = "#####,##0.00"
         ...
         objExcel.Cells(V, H + 6) = ADO3!totaport
         objExcel.Cells(V, H + 7) = ADO3!totdeuda
         objExcel.Cells(V, H + 8) = ADO3!totadela
         objExcel.Cells(V, H + 9) = ADO3!netsocio
         objExcel.Cells(V, H + 10) = ADO3!dscsocio
         objExcel.Cells(V, H + 11) = ADO3!difsocio
      ...
      objExcel.Range(objExcel.Cells(V, H + 6), objExcel.Cells(V, H + 11)).NumberFormat = "#####,##0.00"
      objExcel.Range(objExcel.Cells(V, H + 5), objExcel.Cells(V, H + 11)).Font.Color = RGB(255, 0, 0)
      objExcel.Range(objExcel.Cells(V, H + 5), objExcel.Cells(V, H + 11)).Font.Bold = True
      objExcel.Range(objExcel.Cells(V, H + 5), objExcel.Cells(V, H + 11)).Borders.Color = RGB(255, 0, 0)
            
      objExcel.Cells(V, H + 5) = "TOTALES FINALES"
      objExcel.Cells(V, H + 6) = wTotAport
      objExcel.Cells(V, H + 7) = wTotDeuda
      objExcel.Cells(V, H + 8) = wTotAdela
      objExcel.Cells(V, H + 9) = wNetSocio
      objExcel.Cells(V, H + 10) = wDscSocio
      objExcel.Cells(V, H + 11) = wDifSocio
...
Private Sub cmdImprimir_Click()
   ...
   Crys1.ReportFileName = xraiz + "ReportCtaCte\DiecoxSoc.RPT"
...
Private Sub Form_Initialize()
   frmDIECOConxSoc.Left = (Screen.Width - Width) \ 2
   frmDIECOConxSoc.Top = 0
