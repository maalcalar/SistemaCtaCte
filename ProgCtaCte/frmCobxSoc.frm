...
Begin VB.Form frmCobxSoc 
   BorderStyle     =   1  'Fixed Single
   Caption         =   "Reporte de Cobranzas Por Socio"
   ClientHeight    =   8055
   ClientLeft      =   45
   ClientTop       =   435
   ClientWidth     =   13845
   ...
   Begin VB.ComboBox cmbCia 
      Height          =   315
      ItemData        =   "frmCobxSoc.frx":0000
      Left            =   1080
      List            =   "frmCobxSoc.frx":0002
...
Private Sub cmdImprimir_Click()
   ...
   Crys1.ReportFileName = xraiz + "ReportCtaCte\CobxSoc.RPT"
...
Private Sub Form_Load()
   frmCobxSoc.Left = (Screen.Width - Width) \ 2
   frmCobxSoc.Top = 0
End Sub
